...
- node: docs/governance/changes/change-records.md
  ...
  - records:
    - yaml:
      ...
      - id: "CR-20260305-005"
        date: "2026-03-05"
        summary: "Added quests menu visibility, fixed movement mode spec gaps for swim, resolved GUI navigation slot conflicts, and deleted deprecated docs."
        files:
          - "docs/gui/menu.md"
          - "docs/gui/quests.md"
          - "docs/gui/README.md"
          ...
          - "docs/governance/conflicts/resolutions.md"
          - "docs/governance/changes/change-records.md"
        notes: "Canonical docs now require a quests entrypoint from menu and include `swim` as a first-class movement mode."
  ```
